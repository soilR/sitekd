...
data <- tribble( ~year, ~event, ~displ,
                ...
                as.Date("1934-01-01"), "Brown, EH is an intensity parameter and introduction of poise as measure of redox capacity", 0.1,
...
p <- data %>%
  ...
  scale_y_date(date_labels = "%Y", date_breaks = "10 years") +
...
ggsave(plot = p, filename = "content/project/funda-time/time.png", width = 7, height = 11)
